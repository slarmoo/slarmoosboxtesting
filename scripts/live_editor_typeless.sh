...
npx concurrently \
  "npx esbuild --format=iife --keep-names --global-name=beepbox --define:TESTING=true --bundle ./synth/synth.js --outfile=website/beepbox_synth.js --sourcemap --watch" \
	"npx esbuild --format=iife --keep-names --global-name=beepbox --define:TESTING=true --bundle ./editor/main.js --outfile=website/beepbox_editor.js --sourcemap --watch" \
