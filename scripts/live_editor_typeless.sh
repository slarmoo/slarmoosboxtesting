...
npx concurrently \
  ...
  "npx esbuild --format=esm --keep-names --platform=neutral --bundle ./synth/processor.ts --outfile=website/beepbox_processor.js --sourcemap --watch" \
  "npx esbuild --format=esm --keep-names --platform=neutral --bundle ./synth/synthThread.ts --outfile=website/beepbox_synth_processor.js --sourcemap --watch --define:TESTING=true --define:document={} --define:alert=console.log" \
