...
npx concurrently \
  ...
  "npx esbuild --format=esm --keep-names --platform=neutral --main-fields=main --bundle ./synth/processor.ts --outfile=website/beepbox_processor.js --sourcemap --watch" \
  "npx esbuild --format=esm --keep-names --platform=neutral --main-fields=main --bundle ./synth/synthThread.ts --outfile=website/beepbox_synth_processor.js --sourcemap --watch --define:TESTING=true --define:document={} --define:alert=console.log" \
  "npx esbuild --format=iife --keep-names --global-name=beepbox --bundle ./player/main.js --outfile=website/player/beepbox_player.min.js --sourcemap --watch --define:OFFLINE=false --define:TESTING=true --define:ISPLAYER=true " \
	"npx esbuild --format=iife --keep-names --global-name=beepbox --bundle ./editor/main.js --outfile=website/beepbox_editor.js --sourcemap --watch --define:TESTING=true --define:ISPLAYER=false " \
