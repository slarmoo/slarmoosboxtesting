...
npx concurrently \
  "npx esbuild --format=esm --keep-names --platform=neutral --bundle ./synth/synth_processor.ts --outfile=website/beepbox_synth_processor.js --sourcemap --watch --define:TESTING=true --define:document={} " \
